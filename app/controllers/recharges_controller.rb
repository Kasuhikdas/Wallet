class RechargesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @recharge.save
        format.html { redirect_to '/home/index', notice: 'Recharge was successfully created.' }
        format.json { render :show, status: :created, location: @recharge }
      else
        format.html { redirect_to '/home/index', notice: 'Insufficent Balance Recharge Unsuccessful' }
  ...
  private
    ...
    def recharge_params
      params.require(:recharge).permit(:user_id, :number, :operator_id, :amount)
    end
end
