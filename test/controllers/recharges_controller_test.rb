...
class RechargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recharge" do
    assert_difference('Recharge.count') do
      post recharges_url, params: { recharge: { amount: @recharge.amount, operator_id: @recharge.operator_id, user_id: @recharge.user_id } }
    end
  ...
  test "should update recharge" do
    patch recharge_url(@recharge), params: { recharge: { amount: @recharge.amount, operator_id: @recharge.operator_id, user_id: @recharge.user_id } }
